        ...
        <div className="lg:col-span-4 space-y-4">
          ...
          {contact.socialLinks && (
            <div className="bg-[var(--bg-card)] border border-[var(--border-theme)] rounded-2xl p-4 shadow-sm flex items-center justify-around">
              ...
              >
                <svg className="w-5 h-5 fill-current text-emerald-500 transition-colors" viewBox="0 0 24 24">
              ...
              >
                <svg className="w-5 h-5 fill-current text-blue-500 transition-colors" viewBox="0 0 24 24">
