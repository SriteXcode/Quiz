...
export const BottomNav = ({ activeTab, setActiveTab }) => {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-[40] bg-[var(--bg-card)]/95 backdrop-blur-lg border-t border-[var(--border-theme)] shadow-2xl px-2 py-1.5 transition-colors duration-300">
